...
func New(l *lexer.Lexer) *Parser {
	...
	p.registerInfix(token.LPAREN, p.parseCallbackExpression)
...
func (p *Parser) parseCallbackExpression(function ast.Expression) ast.Expression {
...
func (p *Parser) curPrecedences() int {
